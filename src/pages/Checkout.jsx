                ...
                <div className="container bg-white" >
                    ...
                    <div className="row pb-5">
                        <div className="col-md-8 mb-4">
                            ...
                            <input type="text" className='input-control w-50 mb-3' placeholder='Enter Name..' />

                            <label htmlFor="">Modile <small className='text-danger'>*</small></label>
                            <input type="text" className='input-control w-50 mb-3' placeholder='Enter Mobile Number' />

                            <label htmlFor="">Email <small className='text-danger'>*</small></label>
                            <input type="text" className='input-control w-50 mb-3' placeholder='Enter Email' />
